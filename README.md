...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/qrules-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qrules-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `qrules` available on your platform:
...
```
pixi search qrules --channel conda-forge
```
